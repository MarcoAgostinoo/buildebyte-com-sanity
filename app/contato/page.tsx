  ...
  return (
    <div className="min-h-screen bg-zinc-50 py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
      ...
      <div className="max-w-2xl w-full mb-8 text-center sm:text-left">
        <div className="inline-flex items-center gap-2 mb-4 px-3 py-1 rounded-full bg-blue-100 text-blue-700 border border-blue-200">
      ...
      <div className="mt-12 text-center">
        <p className="text-xs font-mono text-zinc-500">
          PREFERE CRIPTOGRAFIA? ENVIE PGP KEY PARA <span className="text-zinc-900">security@VetorEstrategico.com</span>
        </p>
      </div>
    </div>
  );
