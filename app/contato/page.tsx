...
export default function ContatoPage() {
  return (
    <div className="min-h-screen bg-background py-16 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
      ...
      {/* Cabeçalho da Página */}
      <div className="max-w-2xl w-full mb-10 text-center sm:text-left">
        
        <div className="inline-flex items-center gap-2 mb-4 px-3 py-1 rounded-full bg-primary/10 text-primary border border-primary/20">
