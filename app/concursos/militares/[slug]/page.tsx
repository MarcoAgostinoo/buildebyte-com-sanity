...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://vetorestrategico.com/concursos/militares/${post.slug}`,
    },
    ...
    openGraph: {
      ...
      description: post.seoDescription || post.excerpt,
      type: "article",
      url: `https://vetorestrategico.com/concursos/militares/${post.slug}`,
          ...
          <main className="w-full lg:w-2/3">
            <nav aria-label="Breadcrumb" className="mb-4 text-sm text-foreground/50">
              <ol className="flex items-center gap-2 flex-wrap">
                ...
                <li><Link href="/concursos" className="hover:text-primary">Concursos</Link></li>
                <li><span className="text-foreground/30">&gt;</span></li>
                <li><p className="font-semibold text-foreground">Militares</p></li>
              </ol>
            </nav>
            <div className="mb-6">
              <PressaoBrasil />
