...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://vetorestrategico.com/militar/arsenal/${post.slug}`,
    },
    ...
    openGraph: {
      ...
      description: post.seoDescription || post.excerpt,
      type: "article",
      url: `https://vetorestrategico.com/militar/arsenal/${post.slug}`,
...
export default async function PostPage({
  ...
  console.log('[ARSENAL DEBUG]', { pilarSlug: post.pillar?.slug, relatedPostsCount: relatedPosts.length, relatedPosts });
