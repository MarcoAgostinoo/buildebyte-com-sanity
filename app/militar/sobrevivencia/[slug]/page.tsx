...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://vetorestrategico.com/militar/sobrevivencia/${post.slug}`,
    },
    ...
    openGraph: {
      ...
      description: post.seoDescription || post.excerpt,
      type: "article",
      url: `https://vetorestrategico.com/militar/sobrevivencia/${post.slug}`,
...
export default async function PostPage({
  ...
  console.log('[SOBREVIVENCIA DEBUG]', { pilarSlug: post.pillar?.slug, relatedPostsCount: relatedPosts.length, relatedPosts });
          ...
          <main className="w-full lg:w-2/3">
            <nav aria-label="Breadcrumb" className="mb-4 ml-2 text-sm text-foreground/50">
              <ol className="flex items-center gap-2 flex-wrap">
                ...
                <li><span className="text-foreground/30">&gt;</span></li>
                <li><Link href="/pilares/manual-de-sobrevivencia" className="hover:text-primary">Sobrevivência</Link></li>           
              </ol>
            </nav>
            <div className="mb-6">
              <PressaoBrasil />
