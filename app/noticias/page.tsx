    ...
    <div className="max-w-9xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      <header className="mb-8">
        ...
        <p className="text-zinc-600 max-w-3xl">
          Cobertura técnica de eventos com foco em capacidade militar, tecnologia aplicada, 
          infraestrutura crítica e impacto sistêmico. Análise, não manchete. 
          Direção estratégica para o Brasil.
        </p>
      </header>
